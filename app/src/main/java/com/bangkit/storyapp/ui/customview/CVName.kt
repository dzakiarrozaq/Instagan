...
class CVName : AppCompatEditText, View.OnTouchListener {
    ...
    override fun onDraw(canvas: Canvas) {
        super.onDraw(canvas)
        context.apply {
            setTextColor(ContextCompat.getColor(this, R.color.teal_mid))
            setHintTextColor(ContextCompat.getColor(this, R.color.teal_mid))
